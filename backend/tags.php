      ...
      <div class="p-4 rounded-md shadow-md border border-gray-300 justify-between mt-2 ">
        ...
        <body class="bg-gray-100">
          ...
          <div class="w-full">
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                      ...
                      <td class="px-6 py-4 text-right">
                        ...
                        <div class="flex gap-2 mt-4">
                          ...
                          <button onclick="deleteTagJs(<?php echo $row['id']; ?>)"
            ...
            <div class=" mx-auto bg-gray-100 p-4 rounded-md shadow-md mb-4 mt-4">
              <div class="mb-4">
                <div class="mb-4">

                  <script>
                    function deleteTagJs(tagId) {
                      ...
                      Swal.fire({
                        ...
                        if (result.isConfirmed) {
                          window.location.href = 'delete_tag.php?id=' + tagId;
                        }
                      });
                    }
                  </script>
